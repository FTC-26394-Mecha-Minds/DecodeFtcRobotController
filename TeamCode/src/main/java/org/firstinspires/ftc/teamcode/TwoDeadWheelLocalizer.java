...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 197.08253301854973; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 2657.9130737519877; // x position of the perpendicular encoder (in tick units)
    }
